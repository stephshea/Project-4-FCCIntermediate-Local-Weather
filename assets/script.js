...
function display(data) {
	...
	return "<h3>" + data.weather[0].description + "<img src='https://openweathermap.org/img/w/" + data.weather[0].icon + ".png'></h3>" + "<h3>Wind: " + wind + " mph</h3>" + "<h3>Humidity: " + data.main.humidity + "%</h3>";
}
...
//background imgs for each icon.png
//rain -
else if (icon = "10d") {
...
//SNOW
	...
	$('body').css('background-image', 'url(https://images.unsplash.com/photo-1420585269105-d908ec316eb3?auto=format&fit=crop&w=1650&q=80&ixid=dW5zcGxhc2guY29tOzs7Ozs%3D)');
}
//mist
else if (icon = "50d") {
