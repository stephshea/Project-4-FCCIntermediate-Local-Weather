...
function display(data) {
 ...
 $('body').css('background-image', 'url(https://images.unsplash.com/photo-1469196397362-cd5d038a9df8?auto=format&fit=crop&w=1650&q=80&ixid=dW5zcGxhc2guY29tOzs7Ozs%3D)');
 }
 //scattered clouds -
 else if (icon === "03d") {
